...
def parse_args():
    ...
    data_path.add_argument("--edge_index_path", type=str, default="/data/jeongwoo/amazon_instruments_user_all.npz")
    data_path.add_argument("--features_path", type=str, default="/data/jeongwoo/amazon_instruments_features.npy")
    data_path.add_argument("--labels_path", type=str, default="/data/jeongwoo/amazon_instruments_labels.pkl")
    data_path.add_argument("--split_file", type=str, default="/data/jeongwoo/amazon_instruments_split_masks.pkl")
    data_path.add_argument("--user_text_path", type=str, default="/data/jeongwoo/amazon_instruments_user_text.pkl")
    ...
    data_bert.add_argument(
        "--bert_embedding_path", type=str, default="/data/jeongwoo/node_embeddings/bert.pt", help="Path to the BERT embedding file"
    )
    data_bert.add_argument(
